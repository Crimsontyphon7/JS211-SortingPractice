...
const stringsToNumbs = (numbers) => {
    ...
    arrNums = numbers.map(string => parseInt(string));
    return arrNums;
}
...
const sumEvens = (numbers) => {
    evensum = numbers.map(string => parseInt(string))
...
const atxIdx = strNums.map(string => parseInt(string)).findIndex((number, index) => number + index === 512);
...
//using a high order function, create an array unique of  weather state name values of the weather array, your function should return the following array
...
console.log('unique weather state names: ', weatherStates);
// find all the wetaher state name values 
//map function 
//filter
//find the id of an object that has a min temp of 15.915

const idealTemp = weather
    .find(weatherState => weatherState ['min_temp'] === 15.915) ['id'];
